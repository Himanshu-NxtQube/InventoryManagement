...
def infer_Q3_Q4(image_path, rack_dict: dict) -> dict:
    ...
    if 'Q1' in rack_dict.keys() and 'Q2' in rack_dict.keys():
        ...
        rack_id_Q1 = rack_dict['Q1'].split('-')
        rack_id_Q2 = rack_dict['Q2'].split('-')

        rack_id_Q4 = [rack_id_Q1[0], rack_id_Q1[1][0] + str(int(rack_id_Q1[1][1]) - 1), rack_id_Q1[2]]
        rack_id_Q3 = [rack_id_Q2[0], rack_id_Q2[1][0] + str(int(rack_id_Q2[1][1]) - 1), rack_id_Q2[2]]

        rack_dict['Q4'] = '-'.join(rack_id_Q4)
        rack_dict['Q3'] = '-'.join(rack_id_Q3)
        ...
        rack_dict['Q3'] = rack_dict['Q4'][:-1] + side 
        ...
        rack_dict['Q4'] = rack_dict['Q3'][:-1] + side 
...
if __name__ == '__main__':
    ...
    print("Example 2:", infer_Q3_Q4("",{'Q1':'I9-R5-B'}))
